...
export async function add_blueprint(client, module_hash, config = undefined) {
    let request;
...
export async function put_file_size(client, relay, cid, ipfs, service_id, logSize, error, config = undefined) {
    let request;
    const promise = new Promise((resolve, reject) => {
        const r = new RequestFlowBuilder()
            .disableInjections()
...
export async function remove_service(client, relay, service_id, config = undefined) {
    let request;
    const promise = new Promise((resolve, reject) => {
        const r = new RequestFlowBuilder()
            .disableInjections()
...
export async function add_module(client, name, path, config = undefined) {
    let request;
    const promise = new Promise((resolve, reject) => {
        const r = new RequestFlowBuilder()
            .disableInjections()
...
export async function deploy_service(client, relay, cid, ipfs, error, config = undefined) {
    let request;
    const promise = new Promise((resolve, reject) => {
        const r = new RequestFlowBuilder()
            .disableInjections()
